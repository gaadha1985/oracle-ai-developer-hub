...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from OpenClaw to PicoOraClaw",
		Args:  cobra.NoArgs,
  ...
  picoclaw migrate --force`,
	...
	cmd.Flags().StringVar(&opts.PicoOraClawHome, "picoclaw-home", "",
		"Override PicoOraClaw home directory (default: ~/.picooraclaw)")
