...
// OracleDBConfig holds Oracle AI Database connection and feature settings.
type OracleDBConfig struct {
	...
	WalletPath        string `json:"walletPath"          env:"PICO_ORACLE_WALLET_PATH"`       // ADB mTLS
	PoolMaxOpen       int    `json:"poolMaxOpen"         env:"PICO_ORACLE_POOL_MAX_OPEN"`
	PoolMaxIdle       int    `json:"poolMaxIdle"         env:"PICO_ORACLE_POOL_MAX_IDLE"`
	ONNXModel         string `json:"onnxModel"           env:"PICO_ORACLE_ONNX_MODEL"`
	EmbeddingProvider string `json:"embeddingProvider"   env:"PICO_ORACLE_EMBEDDING_PROVIDER"` // "onnx" or "api"
	EmbeddingAPIBase  string `json:"embeddingApiBase"    env:"PICO_ORACLE_EMBEDDING_API_BASE"`
	EmbeddingAPIKey   string `json:"embeddingApiKey"     env:"PICO_ORACLE_EMBEDDING_API_KEY"`
	EmbeddingModel    string `json:"embeddingModel"      env:"PICO_ORACLE_EMBEDDING_MODEL"`
	AgentID           string `json:"agentId"             env:"PICO_ORACLE_AGENT_ID"`
}

// IsADB returns true when the connection targets an Autonomous Database.
func (o OracleDBConfig) IsADB() bool { return o.Mode == "adb" }

// UsesWallet returns true when mTLS wallet authentication is configured.
func (o OracleDBConfig) UsesWallet() bool { return o.WalletPath != "" }

// UsesTLS returns true when wallet-less TLS via DSN is configured.
func (o OracleDBConfig) UsesTLS() bool { return o.DSN != "" }
